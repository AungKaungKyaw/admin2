            ...
            <div class="row">
                <div class="col-lg-12">
                    <form method="post">
                        ...
                        <div class="col-lg-12">
                            <label>Nrc</label>
                            <input type="text" name="nrc" placeholder="Enter Nrc " class="form-control" value="<?php if(isset($nrc)) echo $nrc; ?>">
                            <span class="text-danger"><?php if(isset($nrc_error)) echo $nrc_error;  ?></span>

                        </div>
                        <div class="col-lg-12">
                            <label>Position</label>
                            <input type="text" name="position" placeholder="Enter Position" class="form-control" value="<?php if(isset($position)) echo $position; ?>">
                        ...
                        <div class="col-lg-12">
                            <label>Phone</label>
                            <input type="text" name="phone" placeholder="Enter Phone " class="form-control" value="<?php if(isset($phone)) echo $phone; ?>">
                            <span class="text-danger"><?php if(isset($phone_error)) echo $phone_error;  ?></span>

                        </div>
                        <div class="col-lg-12">
                            <label>Address</label>
                            <input type="text" name="address" placeholder="Enter Address" class="form-control" value="<?php if(isset($address)) echo $address; ?>">
